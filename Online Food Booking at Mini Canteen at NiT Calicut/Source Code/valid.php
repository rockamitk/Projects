...
<form method="post" action="<?php $_SERVER["PHP_SELF"];?>">
   ...
   <br><br>
   <label>Website:</label> <input type="text" name="website" value="<?php echo $website;?>"> <span class="error"><?php echo $websiteErr;?></span>
   <br><br>
   <label>Comment:</label> <input type="text" name="comment" value="<?php echo $comment;?>">
   <br><br>
   <label>Gender:</label>
