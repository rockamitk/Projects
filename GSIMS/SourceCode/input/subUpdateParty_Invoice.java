...
public class subUpdateParty_Invoice extends JFrame
{
  ...
  public subUpdateParty_Invoice(String str1,String str2,String str3)
  {
    super("Update");
    ...
    ttl=new JLabel("INVOICE UPDATION ");
 ...
 public void findInv()
      { 
        try
         ...
         rs=statement.executeQuery("select invno,sum(invamt) from Party_Invoice group by invno having invno='"+s+"'");
             rs.next();
             st=rs.getString(2);
             t5.setText(st);
           }
     ...
     public void actionPerformed(ActionEvent e)
       {
        try
      ...
      else
         {
          ...
          amountCal();
          updateProduct(s,str8,str7);
          statement.executeUpdate("update Party_Invoice set invdate='"+str6+"',qty='"+str5+"',mrp='"+str7+"',invamt='"+str4+"' where invno='"+str1+"' and pcode='"+str2+"' and pdcode='str3'");
 ...
 public void updateProduct(String s,String str8,String str7)
     {
	...
	a=Float.parseFloat(s2);

       
          rs=statement.executeQuery("select qty from  Party_Invoice where invno='"+s+"' and pdcode='"+str8+"'");
           rs.next();
	...
	st=String.valueOf(tq);
	  c=b+b*a/100;
        ...
        statement.executeUpdate("update Product_Details set qty='"+st+"',uprice='"+str7+"',mrp='"+st1+"' where pdcode='"+str8+"'");
	 statement.executeUpdate("commit");
...
/*
  ...
  {
   subUpdateParty_Invoice supi=new subUpdateParty_Invoice("PI001","s0001","P0001");
  }*/
