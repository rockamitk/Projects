...
public class deleteOutward extends JFrame 
{
      ...
      private class cbListener implements ActionListener
      {
         public void actionPerformed(ActionEvent e)
         {
			...
			cb2.removeAllItems();
             ...
             try
               {
               rs=statement.executeQuery("select pdcode from Outward where outno='"+str1+"'");
     ...
     public void actionPerformed(ActionEvent e)
       {
        try
           ...
           else
           {
            ...
            statement.executeUpdate("delete from Outward where outno='"+str1+"' and pdcode='"+str3+"'");
  ...
  public void updateProduct(String str1,String str3)
	...
	int q1,q,tq;
       try
          ...
          rs=statement.executeQuery("select qty from  Outward where outno='"+str1+"' and pdcode='"+str3+"'");
           rs.next();
...
/*
  ...
  {
        deleteOutward dof= new deleteOutward();
  }  */
