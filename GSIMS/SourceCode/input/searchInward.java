...
public class searchInward extends JFrame 
{
        ...
        try
         {
          ...
          rs=statement.executeQuery("select group_code,pdcode,TO_CHAR(inwdate,'DD-MON-YYYY'),qty,mrp,inwamt from Inward where inwno='"+str6+"'");
...
/*
  ...
  {
        searchInward si= new searchInward();
  }*/
}
