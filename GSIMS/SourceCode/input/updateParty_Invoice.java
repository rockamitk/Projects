...
public class updateParty_Invoice extends JFrame 
{
      ...
      private class cbListener implements ActionListener
      {
         public void actionPerformed(ActionEvent e)
         {
			...
			cb2.removeAllItems();
                  try
                     {
                       rs=statement.executeQuery("select pdcode from Party_Invoice where pcode='"+str2+"' order by pdcode");
                      while(rs.next())
                        {
 ...
 private class okListener implements  ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
                  ...
                  new subUpdateParty_Invoice(str1,str2,str3);
                }
...
/*
  ...
  {
        updateParty_Invoice upi= new updateParty_Invoice();
  }*/
