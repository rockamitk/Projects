...
public class subUpdateOutward extends JFrame
{
  ...
  public subUpdateOutward(String s1,String s2,String s3)
  {
    super("Update");
     ...
     public void actionPerformed(ActionEvent e)
       {
        try
      ...
      else
         {
          ...
          amountCal();
 	 updateProduct();
          statement.executeUpdate("update Outward set outdate='"+str2+"',qty='"+str1+"',mrp='"+str3+"',outamt='"+str4+"' where outno='"+str6+"' and group_code='"+str7+"' and pdcode='"+str8+"'");
	...
	int q1,q2,q,tq;
       ...
       try
        ...
        q=Integer.parseInt(rs.getString(1));
          ...
          rs=statement.executeQuery("select qty from  Outward where outno='"+str6+"' and pdcode='"+str8+"'");
           rs.next();
...
/*
  ...
  {
        subUpdateOutward suo= new subUpdateOutward("O0005","G0001","P0003");
  }*/
