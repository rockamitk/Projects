...
public class subUpdateCustomer_Invoice extends JFrame
{
  ...
  public subUpdateCustomer_Invoice(String s1,String s2,String s3)
  {
    super("Update");
...
public void findMrp()
         {
             ...
             try
               {
               rs=statement.executeQuery("select mrp from product_details where pdcode='"+str8+"'");
               rs.next();
 ...
 public void findInv()
      { 
        try
             ...
             rs=statement.executeQuery("select invno,sum(invamt) from Customer_Invoice group by invno having invno='"+str6+"'");
     ...
     public void actionPerformed(ActionEvent e)
       {
        try
      ...
      else
         {
          ...
          amountCal();
	 updateProduct(str6,str8);

          statement.executeUpdate("update Customer_Invoice set invdate='"+str2+"',qty='"+str1+"',mrp='"+str3+"',invamt='"+str4+"' where invno='"+str6+"' and ccode='"+str7+"'");
 ...
 public void updateProduct(String str6,String str8)
     {
	...
	int q1,q2,q,tq;
       ...
       try
          ...
          rs=statement.executeQuery("select qty from  Product_Details where pdcode='"+str8+"'");
           rs.next();
        ...
        q=Integer.parseInt(s1);
          ...
          rs=statement.executeQuery("select qty from  Customer_Invoice where invno='"+str6+"' and pdcode='"+str8+"'");
           rs.next();
	...
	st=String.valueOf(tq);
        ...
        statement.executeUpdate("update Product_Details set qty='"+st+"' where pdcode='"+str8+"'");
	 statement.executeUpdate("commit");
  ...
  {
   subUpdateCustomer_Invoice suci=new subUpdateCustomer_Invoice("CI001","C0001","P0002");
  }
  */
}
