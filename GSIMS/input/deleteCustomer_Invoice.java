...
public class deleteCustomer_Invoice extends JFrame 
{
     ...
     public void actionPerformed(ActionEvent e)
       {
	    ...
	    str2=t1.getText();
		 ...
		 updateProduct(str1,str3);
            ...
            statement.executeUpdate("delete from Customer_Invoice where invno='"+str1+"' and ccode='"+str2+"' and pdcode='"+str3+"'");
 ...
 public void updateProduct(String str1,String str3)
	...
	int q1,q,tq;
       try
          ...
          rs=statement.executeQuery("select qty from  Customer_Invoice where invno='"+str1+"' and pdcode='"+str3+"'");
           rs.next();
...
/*
  ...
  {
        deleteCustomer_Invoice dci= new deleteCustomer_Invoice();
  }  */
