...
public class updateInward extends JFrame 
{
  ...
  public void inwardCombo()
      ...
      private class cbListener implements ActionListener
      {
         ...
         if(e.getSource()==cb1)
	    {
            ...
            try
              {
               rs=statement.executeQuery("select distinct(group_code) from Inward where inwno='"+str1+"' order by group_code");
                while(rs.next())
		{
	...
	if(e.getSource()==cb2)
	    ...
	    try
	       ...
	       str1=String.valueOf(cb1.getSelectedItem()).trim();
               ...
               rs=statement.executeQuery("select distinct(pdcode) from Inward where inwno='"+str1+"'and group_code='"+str2+"' order by pdcode");
                while(rs.next())
		{
 ...
 private class okListener implements  ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
                 ...
                 new subUpdateInward(str1,str2,str3);
                }
...
/*
  ...
  {
        updateInward ui= new updateInward();
  }*/
