...
public class Outward extends JFrame
{
  ...
  String[] fieldhead={"OUTWARD NO","DATE","GROUP CODE","PRODUCT CODE","QUANTITY"," MRP ","CURRENT AMOUNT"};
 ...
 //   table.setBackground(new Color(200,160,160));
  ...
  public void groupCodeCombo()
          ...
          try
             {
               ...
               rs=statement.executeQuery("select distinct(group_code) from Product_Details order by group_code");
               while(rs.next())
               {
        ...
        private class om implements ActionListener
        {
                public void actionPerformed(ActionEvent e)
                {
                       try
                       {
                        rs=statement.executeQuery("select uprice from product_details where pdcode='"+String.valueOf(cb2.getSelectedItem()).trim()+"'");
                        rs.next();
  ...
  private class enterListener implements ActionListener
      {
         public void actionPerformed(ActionEvent e)
         {
           ...
           if(e.getSource()==cb2)
           {
             ...
             try
               {
               rs=statement.executeQuery("select uprice from product_details where pdcode='"+st+"'");
               rs.next();
               t6.setText(rs.getString(1));
               ...
               {
                  JOptionPane.showMessageDialog(null,"Price Error"+sqle);
  ...
  public void amountCal(Float invamt)
	...
	try

            {
             ...
             rs=statement.executeQuery("select outno,sum(outamt) from Outward group by outno having outno='"+str1+"'");
   ...
   public void clear()
      {
       ...
       try
          {
           rs=statement.executeQuery("select * from lOutward");
           rs.next();
    ...
    public void updateProduct(String str4,String str5)
     {
	...
	int q1,q,tq;
       try
		...
		q=Integer.parseInt(str5);
          ...
          rs=statement.executeQuery("select qty from  Product_Details");
           rs.next();
	...
	str=String.valueOf(tq);
        ...
        statement.executeUpdate("update Product_Details set qty='"+str+"' where pdcode='"+str4+"'");
       ...
       public void actionPerformed(ActionEvent e)
           ...
           try
            {
             ...
             rs=statement.executeQuery("select pdcode from Outward where outno='"+str1+"' and group_code='"+str3+"'");
              while(rs.next())
               {
              ...
              if(flg==1)
             ...
             else
                {
                   ...
                   amountCal(invamt);
                    updateProduct(str4,str5);
         

                   statement.executeUpdate("insert into Outward values('"+str1.trim()+"','"+str2.trim()+"','"+str3.trim()+"','"+str4.trim()+"','"+str5.trim()+"','"+str6.trim()+"','"+str7.trim()+"')");
                   statement.executeUpdate("commit");
		...
		int a,b;
                 ...
                 str1=t1.getText();
                     ...
                     rs=statement.executeQuery("select outno from lOutward");
                     rs.next();
                     st2=rs.getString(1);
             st=st2.substring(2);
             ...
             b=Integer.parseInt(str);
                  ...
                  try
                     ...
                     rs.next();
                     str1="O"+rs.getString(1);
   
                     
                      statement.executeUpdate("Update lOutward set outno='"+str1+"'");
                       statement.executeUpdate("commit");
      ...
      public void actionPerformed(ActionEvent e)
        {
          ...
          k=JOptionPane.showConfirmDialog(null,"OK=New Record AND NO=EDIT IN EXISTING","INFO",JOptionPane.INFORMATION_MESSAGE);
          ...
          else
          {
           try
            {
             str1=JOptionPane.showInputDialog("Enter Outward No For Edit");
             rs=statement.executeQuery("select * from Outward where outno='"+str1+"'");
             rs.next();
        ...
        try
         {
          ...
          statement.executeUpdate("commit");
          rs=statement.executeQuery("select outno,TO_CHAR(outdate,'DD-MON-YYYY'),group_code,pdcode,qty,mrp,outamt from Outward order by outno");
