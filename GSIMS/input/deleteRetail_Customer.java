...
public class deleteRetail_Customer extends JFrame 
{
  ...
  public deleteRetail_Customer()
  {
		...
		cn.add(l1);cn.add(cb1);
    		    ...
    		    fr.pack();
                    fr.setSize(500,300);
		    fr.setVisible(true);
                    cn.setBackground(new Color(150,150,150));
     ...
     public void actionPerformed(ActionEvent e)
       {
        try
		 ...
		 updateProduct(str1,str3);
            ...
            statement.executeUpdate("delete from Retail_Customer where transno='"+str1+"' and pdcode='"+str3+"'");
 ...
 public void updateProduct(String str1,String str3)
	...
	int q1,q,tq;
       try
          ...
          rs=statement.executeQuery("select qty from  Retail_Customer where transno='"+str1+"' and pdcode='"+str3+"'");
           rs.next();
...
/*
  ...
  {
        deleteRetail_Customer drc= new deleteRetail_Customer();
  }  */
