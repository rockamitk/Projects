...
public class Bulk_Customer_Report extends JFrame 
{
  String[] col={"Invoice NO","Customer Code","Bill Amount","Paid Amount","Dues Amount"};
 ...
 public Bulk_Customer_Report()
 {
       ...
       setLayout(null);
        ...
        cn.setBackground(new Color(160,180,140));
...
public static void main(String args[])
 {
      Bulk_Customer_Report bcr=new Bulk_Customer_Report();
 }*/
